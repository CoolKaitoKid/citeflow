...
--
-- Canonical copy: supabase/migrations/012_mfo_structured_data.sql
-- This admin copy is for the SQL Editor. Safe to re-run.
-- Prerequisite: 011 chairperson approval chain helpers must already exist.
-- =============================================================================
-- =============================================================================
-- CITE-Flow 012 â€” MFO structured data foundation
...
--
-- Packet-level workflow remains Faculty â†’ Chairperson/OIC â†’ Admin via
...
-- Default manhours formula: hours Ã— (male + female).
...
VALUES
  ...
  ('documentation_instruction', 'documentation', NULL, 'Documentation â€” instruction', 'supporting', 190, NULL),
  ('documentation_training', 'documentation', NULL, 'Documentation â€” trainings', 'supporting', 200, NULL),
  ('documentation_postgraduate', 'documentation', NULL, 'Documentation â€” postgraduate', 'supporting', 210, NULL),
  ('documentation_research', 'documentation', NULL, 'Documentation â€” research', 'supporting', 220, NULL),
  ('documentation_extension', 'documentation', NULL, 'Documentation â€” extension', 'supporting', 230, NULL),
  ('documentation_other', 'documentation', NULL, 'Documentation â€” other engagements', 'supporting', 240, NULL)
...
-- ---------------------------------------------------------------------------
-- MFO 1 PI1 â€” Licensure (program-owned)
...
-- ---------------------------------------------------------------------------
-- MFO 1 PI2 â€” Graduate employment (program-owned)
-- ---------------------------------------------------------------------------
...
-- MFO 1 PI3 â€” Enrollment / sections / advisers
...
-- MFO 1 PI5 â€” Certifications (faculty-owned)
...
-- MFO 1 PI6 â€” Postgraduate education (faculty-owned)
...
-- MFO 1 PI8 â€” Instructional materials
...
-- ---------------------------------------------------------------------------
-- Tag existing submission files (additive, nullable â€” current uploads stay valid)
-- ---------------------------------------------------------------------------

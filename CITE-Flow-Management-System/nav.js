...
function navigateTo(pageFile) {
    if (typeof toggleMobileSidebar === "function") {
        toggleMobileSidebar(true); // Isira ang drawer inig pislit og menu item
    }
...
function attachNavEvents() {
    document.addEventListener("click", (e) => {
        // Toggle mobile drawer kung gipislit ang hamburger menu icon
...
function toggleMobileSidebar(forceClose = false) {
    ...
    // Awtomatikong maghimo og backdrop kung wala pa sa page
    if (!backdrop) {
        backdrop = document.createElement("div");
        backdrop.id = "sidebarBackdrop";
        backdrop.className = "sidebar-backdrop";
